...
//
//  Created by sundasheng1985 on 11/18/2018.
...
{
    self.window.rootViewController = [[UINavigationController alloc]initWithRootViewController:[SYZRootViewController new]];
